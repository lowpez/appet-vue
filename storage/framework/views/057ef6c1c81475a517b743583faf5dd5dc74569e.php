<div class="modal fade" id="call" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content d-flex flex-column justify-content-between bg-neutral" style="height: 504px; background-image: url('daitan-b.jpg'); background-position: center; background-size: cover;">
...
<?php /**PATH C:\laragon\www\appet2\resources\views/pet/model.blade.php ENDPATH**/ ?>