    <div class="d-flex flex-column flex-lg-row" id="app"><!-- ALL -->
        <div class="sidebar sidebar-expand-lg order-1 order-lg-0"><!-- CONTENT-->
            ...
            <div class="container-fluid py-5 px-0"><!-- MAIN CONTENT -->
                <div class="container not-me">
                  <!--BUSCADOR POR TAG ID--> <buscador-component :mensaje_success="'Gracias por Compartir'" :mensaje_error="'error al compartir'" :boton="'ok'"></buscador-component> <!--FIN BUSCADOR POR TAG ID-->
  </div>
<?php /**PATH C:\laragon\www\appet2\resources\views/front/include/header.blade.php ENDPATH**/ ?>