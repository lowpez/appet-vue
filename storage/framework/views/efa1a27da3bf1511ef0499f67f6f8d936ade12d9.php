<footer class="card pt-11 rounded-0"><!-- FOOTER -->
    <div class="container">
        <div class="row">
            <div class="col-sm-6 col-lg-3">
                <h2 class="mb-5 fs-xxs">Extras</h2>
                <ul class="list-unstyled mb-5">
                    <li class="mb-3">
                        <a class="link-body" href="#">Section 1</a>
                    </li>
                    <li class="mb-3">
                        <a class="link-body" href="#">Section 2</a>
                    </li>
                    <li class="mb-3">
                        <a class="link-body" href="#">Section 3</a>
                    </li>
                    <li>
                        <a class="link-body" href="#">Section 4</a>
                    </li>
                </ul>
            </div>
            <div class="col-sm-6 col-lg-3">
                <h2 class="mb-5 fs-xxs">Recursos</h2>
                <ul class="list-unstyled mb-5">
                    <li class="mb-3">
                        <a class="link-body" href="#">FAQ</a>
                    </li>
                    <li class="mb-3">
                        <a class="link-body" href="#">Blog</a>
                    </li>
                    <li>
                        <a class="link-body" href="#">Docs</a>
                    </li>
                </ul>
            </div>
            <div class="col-sm-6 col-lg-3">
                <h2 class="mb-5 fs-xxs">Compañia</h2>
                <ul class="list-unstyled mb-5">
                    <li class="mb-3">
                        <a class="link-body" href="#">Sobre</a>
                    </li>
                    <li class="mb-3">
                        <a class="link-body" href="#">Colabora</a>
                    </li>
                    <li>
                        <a class="link-body" href="#">Contacto</a>
                    </li>
                </ul>
            </div>
            <div class="col-sm-6 col-lg-3 mb-11">
                <a class="link-body" href="#">
                    <svg class="gi gi-github" width="88.73" height="24" viewBox="-0.122 175.062 480.244 129.875" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <ul class="list-unstyled d-flex">
                    <li class="mr-3">
                        <a class="btn btn-circle btn-neutral" href="#">
        ...
        <div class="py-6">
            <div class="row">
                <div class="col-md mb-5 mb-md-0">
                    <p class="text-center text-md-left">© 2020 Appet CL</p>
                </div>
                <div class="col-md">
                    <ul class="list-unstyled d-flex flex-wrap justify-content-center justify-content-md-end">
                        <li>
...
<script src="<?php echo e(asset('js/app.js')); ?>?<?php echo e(rand()); ?>"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/croppie/2.6.4/croppie.js"></script>



<?php /**PATH C:\laragon\www\appet2\resources\views/include/footer.blade.php ENDPATH**/ ?>