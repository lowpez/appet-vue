<?php $__env->startPush('styles'); ?>
    <style>
        .sidebar{
            ...
            background-image: url('<?php echo e(secure_asset('css/bg.jpg')); ?>') !important;
    ...
    <main>
        <div class="py-11">
            <div class="container tag">
                ...
                <geo-component  :id_mascota="<?php echo e($pets->id); ?>" :mensaje_success="'Gracias por Compartir'" :mensaje_error="'error al compartir'" :boton="'ok'"></geo-component>
                <div class="card-group p-sm-0">
                    <div class="p-5 bg-m">
                        <h2 class="lead">Soy <?php echo e($pets->name); ?></h2>
                    </div>
                    <div class="card rounded-bottom">
                        <div class="  d-flex flex-column justify-content-between bg-neutral" style="height: 504px; background-image: url(<?php echo e(asset('media/uploads/pets/'.$pets->full)); ?>); background-position: center; background-size: cover;"></div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-3"><!--  AVATAR Y OTROS -->
                                    <div class="d-flex d-lg-block mb-5 mb-lg-0 text-lg-center" >
                                      <span class="avatar avatar-xxxl mr-3 mr-lg-0 mb-lg-3">
                                        <img src="<?php echo e(asset('media/uploads/users/'.$pets->user->avatar)); ?>" class="rounded-circle avatar-xxxl" alt="Añade una imagen de tu mascota">
                                     </span>
                                        <div class="mb-lg-3">
                                            <h3 class="fs-xxs lh-lg">
                                                <a href="#"><?php echo e($pets->user->name); ?></a>
                                            </h3>
                                            <?php switch($pets->user->pet_type_ptrac):
                                                case (1): ?>
                                ...
                                <div class="col-lg-9"><!--  PET INFO -->
                                    <div class="d-flex align-items-center mb-5">
                                        ...
                                        <p class="mr-auto"><?php echo e($pets->created_at->format('d M, Y')); ?></p>
                                    ...
                                    <p class="mb-2">¡Hola a todos! Mi nombre es <?php echo e($pets->name); ?>. Soy un <?php echo e(\App\Pet_type::getEspecie($pets->pet_type)); ?> <?php echo e(\App\Breed::getBreed($pets->breeds)); ?> y tengo {edad} años. Soy <?php echo e($pets->sexo == 'm' ?'el' : 'la'); ?> regalon<?php echo e($pets->sexo == 'm' ?' ' : 'a'); ?>  de la casa.</p>
                                    <p class="mb-5">Mis papis dicen que <?php echo e($pets->description); ?>. Sobre mi salud soy un poquito polilla<?php echo e($pets->condicion_medica); ?></p>
                                    <div class="d-flex align-items-center"><!-- ICONOS -->
                                        <a href="https://wa.me/<?php echo e($pets->user->phone); ?>?text=Hola!%20Vi%20a%20tu%20mascota%20<3" aria-label="Llama a mi humano" class="d-flex mr-auto ">
                            ...
                            <hr>
                           <comments-component :id_mascota="<?php echo e($pets->id); ?>"></comments-component>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-content p-5">
                    ...
                    <form>
                        ...
                        <div class="input-group">
                            <input class="form-control form-control-lg" id="pageLink" type="text" value="<?php echo e(env('APP_URL')); ?>/tag/<?php echo e($pets->tag_id); ?>" readonly>
        ...
        <!-- / SHARE OPTS -->
        <traspaso-component :id="<?php echo e($pets->id); ?>"></traspaso-component>
    </main>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('front.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/appetcl2/appet/resources/views/pet/perfil.blade.php ENDPATH**/ ?>