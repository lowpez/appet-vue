      ...
      <div class="container">
        <a class="d-none d-lg-inline link-body" rel="home" href="#" aria-label="first link">
          <i class="gi-animation-hover">
            <img src="<?php echo e(secure_asset('logo.svg')); ?>" class="logo img-responsive gi-animation gi-animation-hover-pulse" alt="Logo de Appet CL" />
          </i>
        </a>
        <ul class="nav navside-nav" role="tablist" aria-orientation="vertical">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="tabs" data-info="tooltip" title="<?php echo e(\App\View::getCountNotificacion(Auth::user()->id)); ?>" href="/notifications/" role="tab" aria-controls="notifications" aria-selected="false" aria-label="Notificaciones">
              <i class="gi-animation-hover">
...
<?php /**PATH C:\laragon\www\appet2\resources\views/include/header.blade.php ENDPATH**/ ?>