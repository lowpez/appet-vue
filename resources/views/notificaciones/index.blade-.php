...
<main>
    <div class="py-11">
        <div class="container">
        @if(\App\View::getCountNotificacion(Auth::user()->id)>0)
                ...
                <div class="col-md-6 col-xl-4 mt-5"><!-- 2 COLS MD + SM -->
                    ...
                    <div class="card mb-5 mb-xl-0">
                        <div class="card-body">
                            ...
                            <hr>
                            <div class="d-flex">
                              <span class="avatar avatar-md mr-3 border rounded-circle">
                                <img src="{{asset('upload/pets/'.$notification->pet->avatar)}}" class="image-fluid avatar-md rounded-circle" alt="{{$notification->pet->name}}">
                              </span>
                                <div class="mr-auto">
