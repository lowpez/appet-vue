...
<div style="max-width:98%; min-width:320px; background-color: #f5f5f5; border: 0; margin-right: auto; margin-left: auto; padding: 0.5% 0 0.5% 0;">
    <div style="max-width:550px; min-width:320px;  background-color: white; border: 0; margin-right: auto; margin-left: auto; ">
        <div style="margin-left:30px;margin-right:30px;">
            ...
            <h2 style="color:#212121;font-size:24px;font-weight:bold;">Querido, {subtag:name}!</h2>
            ...
            <table style="width:100%;">
                ...
                <td style="text-align: center; font-size: 18px;line-height:18px;font-weight: bold;"><a href="https://www.appet.cl/"><span style="cursor:pointer;background-color:#7300FF;max-width:300px;padding:15px 25px;display:inline-block;color: #ffffff; text-decoration: none;margin:0 auto;">{confirm}e-mail{/confirm}</span></a></td>
                <td style="width:auto;"></td>
                </th>
            </table>
