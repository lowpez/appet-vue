...
//Comprueba si el usuario tiene datos vacios
Route::get('/comprobar_perfil_user_datos_vacios','UserController@comprobar_datos_vacios');

Route::get('/isdangerus/{id}','PetController@isdangerus');
